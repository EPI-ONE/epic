...
public:
    ...
    bool StoreUnspent(const uint256&, const CKeyID&, uint32_t, uint64_t);
    bool StorePending(const uint256&, const CKeyID&, uint32_t, uint64_t);
    bool StoreSpent(const uint256&, const CKeyID&, uint32_t, uint64_t);
    ...
    ConcurrentHashMap<uint256, std::tuple<CKeyID, uint32_t, uint64_t>> GetAllUnspent();
...
private:
    ...
    ConcurrentHashMap<uint256, std::tuple<CKeyID, uint32_t, uint64_t>> GetAllUTXO(uint8_t);
};
