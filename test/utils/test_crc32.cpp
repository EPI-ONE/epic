...
TEST_F(TestCrc32, long_hex) {
    unsigned char data[] = {0xe4, 0xa0, 0x53, 0xf6, 0xa8, 0x13, 0x6a, 0x71, 0xfc, 0xb2, 0x77, 0x8f, 0xcc, 0xd6, 0x89,
        0x97, 0xf5, 0xa2, 0xff, 0x1a, 0x02, 0xac, 0xfb, 0x68, 0x62, 0xd4, 0x08, 0x04, 0x98, 0x72, 0xae, 0xee};
    uint32_t result      = GetCrc32(data, sizeof(data));
    EXPECT_EQ(result, 0xAAF06E25);
}

TEST_F(TestCrc32, long_hex_2) {
    unsigned char data[] = {0xa0, 0x53, 0xf6, 0xa8, 0x13, 0x6a, 0x71, 0xfc, 0xb2, 0x77, 0x8f, 0xcc, 0xd6, 0x89, 0x97,
        0xf5, 0xa2, 0xff, 0x1a, 0x02, 0xac, 0xfb, 0x68, 0x62, 0xd4, 0x08, 0x04, 0x98, 0x72, 0xae, 0xee};
    uint32_t result      = GetCrc32(data, sizeof(data));
