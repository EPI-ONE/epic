...
public:
    struct TestDerivation {
        ...
        TestDerivation(std::string _pub, std::string _prv, uint32_t _nChild) : pub(_pub), prv(_prv), nChild(_nChild) {}
    };
    ...
    struct TestVector {
        ...
        TestVector& operator()(std::string pub, std::string prv, unsigned int nChild) {
            vDerive.emplace_back(pub, prv, nChild);
            return *this;
        }
    };
    ...
    std::array<TestVector, 3> testData = {
        ...
        TestVector
            {"fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a"
             "5754514e4b484542"}
        ...
        TestVector
            {"4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df"
             "2e5a3c51c73235be"}
